...
export default function AdminOrders() {
  ...
  // function for formatting date to display in the UI
  ...
  /**
   * Handle Order Confirmation via order confirmation  api
   */
  ...
  /**
   * Handle Order Cancellation via order cancellation api
   */
...
//loader function for loading orders for the admin
